	...
	<div class="container">
		...
		<div class="wrapper">
			<ul class="sortable__nav nav">
				...
				<% 
				CategoryClass categoryClass = (CategoryClass) request.getSession().getAttribute("course_categoryClass");
				Set<Course> courses = categoryClass.getCourses();
				
				%>
				<li><a data-sjslink="<%=categoryClass.getCategoryClass_name() %>" class="nav__link"><%=categoryClass.getCategoryClass_name() %></a></li>

				
			</ul>
				<div align="center" style="margin: 10px 0">
					<form class="search1" target="_blank" style="background: #494A5F;" action="${ pageContext.request.contextPath }/course_search.action" method="post">
						<input type="search" placeholder="Search" name="course_name">
					</form>
				</div>
			...
			<div id="sortable" class="sjs-default">
				...
				%>
				<div data-sjsel="<%=course.getCourse_category() %>">
					<div class="card">
				<a href="${ pageContext.request.contextPath }/course_teachVideo.action?course_id=<%=course.getCourse_id()%>">
						<img class="card__picture"
							src="../.././images/<%=categoryClass.getCategoryClass_icon()%>.jpg" alt="">
						<div class="card-infos">
							<h2 class="card__title"><%=course.getCourse_name()%></h2>
							<p class="card__text"><%=course.getCourse_introduce()%></p>
						</div>
					</a>
					</div>
				</div>
