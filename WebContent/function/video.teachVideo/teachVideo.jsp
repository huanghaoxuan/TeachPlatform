	...
	<div class="container">
		...
		<div class="wrapper">
			<ul class="sortable__nav nav">
					<% Course course = (Course) request.getSession().getAttribute("Videos");
					CategoryClass categoryClass = (CategoryClass) request.getSession().getAttribute("course_categoryClass");
					%>
				<li><a data-sjslink="all" class="nav__link"><%=course.getCourse_name() %></a></li>
				
				
			</ul>
				<%-- <div align="center" style="margin: 10px 0">
					<form class="search1" target="_blank" style="background: #494A5F;" action="${ pageContext.request.contextPath }/course_search2.action" method="post">
			...
			<div id="sortable" class="sjs-default">
				...
				<div data-sjsel="all">
					<div class="card">
					<a href="${ pageContext.request.contextPath }/teachVideo_videoMain.action?video_id=<%=teachVideo.getVideo_id()%>">
						<img class="card__picture"
							src="../.././images/<%=categoryClass.getCategoryClass_icon()%>.jpg" alt="">
						<div class="card-infos">
							<h2 class="card__title"><%=teachVideo.getVideo_contentName()%></h2>
							<p class="card__text"><%=teachVideo.getVideo_introduce()%></p>
						</div>
						</a>
					</div>
				</div>
