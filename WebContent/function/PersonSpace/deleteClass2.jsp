...
<fieldset class="layui-elem-field">
  <%
    CategoryClass deleteCatalog_categoryClass = (CategoryClass) request.getSession().getAttribute("deleteCatalog_categoryClass");
    %>
  <legend>正在为课程： <%=deleteCatalog_categoryClass.getCategoryClass_name() %> 删除章节</legend>
  <div class="layui-field-box">
  
   <!-- 添加课程 -->
   <form class="layui-form" action="${ pageContext.request.contextPath }/courseDeleteCatalog.action" onsubmit="return sumbit_form()">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="course_id" lay-verify="required">
                        ...
                        Set<Course> courses = deleteCatalog_categoryClass.getCourses();
