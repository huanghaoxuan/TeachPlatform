...
<body>
	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<div id="sortable" class="sjs-default">
				<%
					List<CategoryClass> categoryClasses = (List<CategoryClass>) request.getSession().getAttribute("search_categoryClasses");
					for (CategoryClass categoryClass : categoryClasses) {
						
				%>
				<div data-sjsel="<%=categoryClass.getCategoryClass_category() %>">
					<div class="card">
				<a href="${ pageContext.request.contextPath }/course_findAll.action?course_category=<%=categoryClass.getCategoryClass_name()%>">
	...
	<div
		...
		<p>本学生网络授课平台正在测试，由黄浩轩及团队成员进行制作，如有bug，欢迎反馈至huanghaoxuan98@163.com</p><br>
