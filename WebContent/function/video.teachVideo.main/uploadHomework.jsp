...
<fieldset class="layui-elem-field">
  ...
  <legend>正在为 ： <%=teachVideo.getVideo_contentName() %> 添加作业
  <a href="${ pageContext.request.contextPath }/teachVideo_homework.action?video_id=<%=teachVideo.getVideo_id() %>" style="color: #01AAED">点击查看</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </legend>
                     ...
                     <div id="easyContainer"></div>
					  ...
					  <script>
					    $('#easyContainer').easyUpload({
					      ...
					      note: '提示：最多一次上传5个文件，上传的文件将用于作业提交',//文件上传说明
