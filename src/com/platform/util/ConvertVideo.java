...
public class ConvertVideo {
	...
	public static void main(String args[]) throws IOException {
		...
		if (process(outputName)) {
			System.out.println("ok");
		}
	}

	public static int getPath(String basePath,String inputpath,String outputpath,String outputname) {
	...
	public static boolean process(String outputName) {
		@SuppressWarnings("unused")
		int type = checkContentType();
		boolean status = false;
		System.out.println("直接转成mp4格式");
		status = processMp4(inputPath,outputName);// 直接转成mp4格式
		return status;
	}
	...
	private static boolean processMp4(String oldfilepath,String outputname) {
		...
		command.add(outputPath + outputname);
		try {
